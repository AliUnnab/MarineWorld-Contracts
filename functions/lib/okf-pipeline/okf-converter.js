...
class OKFConverter {
     ...
     */
    async convertToOKF(rawText, fileName, companyId) {
...
Ardından Markdown içeriği gelmelidir.`;
     ...
     */
    cleanMarkdownBlockWrappers(text) {
     ...
     */
    parseOKFContent(content, defaultCompanyId) {
     ...
     */
    generateMockOKF(rawText, fileName, companyId) {
...
exports.OKFConverter = OKFConverter;
//# sourceMappingURL=okf-converter.js.map